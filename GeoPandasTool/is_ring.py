...
def is_ring(geojson_names: Union[str, List[str]]) -> Union[List[bool], Dict[str, List[bool]]]:
    """
    判断一个或多个 GeoJSON 文件中的 LineString 几何对象是否是 ring（闭合且简单）
    ...
    for name in names:
        ...
        try:
            ...
            # 调用 is_ring
            results[name] = gseries.is_ring.tolist()
