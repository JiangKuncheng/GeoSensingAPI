...
def is_valid(geojson_names: Union[str, List[str]]) -> Union[List[bool], Dict[str, List[bool]]]:
    """
    判断一个或多个 GeoJSON 文件中的几何对象是否是有效的合法几何
    ...
    for name in names:
        ...
        try:
            ...
            # 调用 is_valid
            results[name] = gseries.is_valid.tolist()
