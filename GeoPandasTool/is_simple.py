...
def is_simple(geojson_names: Union[str, List[str]]) -> Union[List[bool], Dict[str, List[bool]]]:
    """
    判断一个或多个 GeoJSON 文件中的几何对象是否 simple（即是否不自交）
    ...
    for name in names:
        ...
        try:
            ...
            # 调用 is_simple
            results[name] = gseries.is_simple.tolist()
